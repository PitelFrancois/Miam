...
class RecipeController extends Controller
{
    ...
    public function update($id)
    {
        ...
        $newRecipe = new RecipeModel;
        // On récupère le nombre des recettes par catégorie
        $aperitifCount = $newRecipe->recipeCount("Apéritif");
        $entranceCount = $newRecipe->recipeCount("Entrée");
        $mainCount = $newRecipe->recipeCount("Plat");
        $dessertCount = $newRecipe->recipeCount("Dessert");
        // On récupère les données
        $data = $newRecipe->findById($id);
        // On hydrate l'objet
        $recipe = $newRecipe->hydrate($data);
